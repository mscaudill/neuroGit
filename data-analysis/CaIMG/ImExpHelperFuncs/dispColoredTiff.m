function [image,imageColorMap] = dispColoredTiff( imageAxes, tiffMatrix,...
                                     stackExtrema, imageNumber,...
                                     scaleFactor, color )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%                       : color, a color for the image

image = tiffMatrix(:,:,imageNumber);

imshow(image, stackExtrema/scaleFactor,'Parent', imageAxes);

imageColorMap = falseColorMaps(cast(stackExtrema(1),'double'),...
                             cast(stackExtrema(2),'double'), 100, color);

function centerCrossScatter(cellTypesofInterest)
% centerCrossScatter creates a population scatterPlot of cross areas
% vs center areas.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for cellType = 1:numel(cellTypesofInterest)
    ...
    scatter(maxCenterAreas{cellType}, maxCrossAreas{cellType}, 50,...
        colors{cellType})
    
    scatter(meanMaxCenterArea(cellType),meanMaxCrossArea(cellType),...
        150,colors{cellType},'^','fill')
    % call the exchange function errorbarxy to plot mean and sems
    errorbarxy(meanMaxCenterArea(cellType), meanMaxCrossArea(cellType),...
        semMaxCenterArea(cellType), semMaxCrossArea(cellType),[],[],...
